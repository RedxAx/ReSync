...
public class CoreNodes implements NodeDefinitionCategory {
    ...
    public void registerNodes(NodeDefinitionRegistry registry) {
        registry.register(new NodeDefinition.Builder("event:click", "On Click", NodeDefinition.NodeCategory.EVENT)
            ...
            .output("slot", NodeDefinition.PinType.DATA, FlowType.NUMBER)
            .output("raw_slot", NodeDefinition.PinType.DATA, FlowType.NUMBER)
            .output("button", NodeDefinition.PinType.DATA, FlowType.NUMBER)
            .output("action", NodeDefinition.PinType.DATA, FlowType.STRING)
            .output("item", NodeDefinition.PinType.DATA, FlowType.ITEMSTACK)
            .output("cursor_item", NodeDefinition.PinType.DATA, FlowType.ITEMSTACK)
            .output("left", NodeDefinition.PinType.FLOW, FlowType.EXECUTION)
            .output("right", NodeDefinition.PinType.FLOW, FlowType.EXECUTION)
            .output("shift_left", NodeDefinition.PinType.FLOW, FlowType.EXECUTION)
            .output("shift_right", NodeDefinition.PinType.FLOW, FlowType.EXECUTION)
            .output("middle", NodeDefinition.PinType.FLOW, FlowType.EXECUTION)
            .output("double_click", NodeDefinition.PinType.FLOW, FlowType.EXECUTION)
            .output("drop", NodeDefinition.PinType.FLOW, FlowType.EXECUTION)
            .output("control_drop", NodeDefinition.PinType.FLOW, FlowType.EXECUTION)
            .output("number_key", NodeDefinition.PinType.FLOW, FlowType.EXECUTION)
            .output("creative", NodeDefinition.PinType.FLOW, FlowType.EXECUTION)
            .output("swap_offhand", NodeDefinition.PinType.FLOW, FlowType.EXECUTION)
            .output("window_border_left", NodeDefinition.PinType.FLOW, FlowType.EXECUTION)
            .output("window_border_right", NodeDefinition.PinType.FLOW, FlowType.EXECUTION)
            .output("unknown", NodeDefinition.PinType.FLOW, FlowType.EXECUTION)
            .build());
